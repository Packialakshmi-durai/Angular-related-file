...
function callreport_instantaneous(month_data, month_year, supply_cat, fonts, AccessToken, ipAddr, invoked_date, crnt_dir) {
	...
	return new Promise(function (resolve) {
		...
		try {
			...
			pdfDoc.pipe(fs.createWriteStream(crnt_dir + "/PDF/" + month_year + "/" + invoked_date + "/" + supply_cat + "_Instantaneous_Report.pdf"));
			pdfDoc.end();
