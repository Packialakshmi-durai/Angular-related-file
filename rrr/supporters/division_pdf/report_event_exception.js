...
function callreport_event_exception(month_data, month_year, supply_cat, fonts, AccessToken, ipAddr, hierarchy_code, invoked_date, filepath, div_name) {
            ...
            try {
                ...
                if (event_data.length != 0) {
                    ...
                    if (fnl_event_json.length != 0) {
                        ...
                        table_format.push({
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{ text: 'Division Name', style: 'contentHeader' }, fnl_event_json[0]['P2'], {}, {}]
                                ]
                            }
                        })
                        ...
                        pdfDoc.pipe(fs.createWriteStream(filepath + invoked_date + "/" + div_name + "/" + supply_cat + "_Event_Exception_Report.pdf"));
                        pdfDoc.end();
