...
function callreport_high_noload_blackout(month_data, month_year, supply_cat, fonts, AccessToken, ipAddr, invoked_date, filepath, div_name) {
	...
	return new Promise(function (resolve) {
		...
		try {
			...
			if (dm.length != 0) {
				...
				pdfDoc.pipe(fs.createWriteStream(filepath + invoked_date + "/" + div_name + "/" + supply_cat + "_High_Noload_Blackout_Report.pdf"));
				pdfDoc.end();
