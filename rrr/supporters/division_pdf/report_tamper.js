...
function callreport_tamper(month_data, month_year, supply_cat, fonts, AccessToken, ipAddr, hierarchy_code, invoked_date, filepath, div_name) {
            ...
            try {
                ...
                if (event_data.length != 0) {
                    ...
                    if (fnl_event_json.length != 0) {
                        ...
                        pdfDoc.pipe(fs.createWriteStream(filepath + invoked_date + "/" + div_name + "/" + supply_cat + "_Tamper_Report.pdf"));
                        pdfDoc.end();
