...
function callreport_summary(month_data, month_year, supply_cat, fonts, AccessToken, ipAddr, hierarchy_code, invoked_date, filepath, div_name) {
            ...
            try {
                ...
                if (meter_data.length != 0) {
                    ...
                    if (final_month_data.length != 0) {
                        ...
                        table_format.push({
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{ text: 'Division Name', style: 'contentHeader' }, final_month_data[0]['division'], {}, {}]
                                ]
                            }
                        })
                        ...
                        pdfDoc.pipe(fs.createWriteStream(filepath + invoked_date + "/" + div_name + "/" + supply_cat + "_Summary_Report.pdf"));
                        pdfDoc.end();
